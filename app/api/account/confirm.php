...
class api_module_account_confirm extends api_module_account_shared
{
    function post_index()
    {
        ...
        if ($WUser->getWUserID())
        {
            $notification = new \Novut\Tools\Notification('account.enduser.confirm');
...
(new api_module_account_confirm)->init();